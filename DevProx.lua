...
local UserName = (dp.username_ or "CODEARAB")
...
if text and text:match('^'..(DevAbs:get(DevProx..'Abs:NameBot') or "فايروس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(DevProx..'Abs:NameBot') or "فايروس")..' ','')
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'CODEARAB')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'CODEARAB')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local inline = {{{text="⌁ المطور .",url="t.me/"..(dp.username_ or "CODEARAB")}}}
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '⌁︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "CODEARAB")..')', 1, 'md') 
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@CODEARAB]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@CODEARAB]'))
Dev_Abs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source Virus     --
--        Contact         --
...
local BotName = (DevAbs:get(DevProx.."Abs:NameBot") or 'فايروس')
...
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'فايروس')
local DevProxTEAM = {"لتقول بوت اسمي "..NameBot.." 😒🔪","اسمي القميل "..NameBot.." 😚♥️","عندي اسم تره 😒💔","قولولي "..NameBot.." كفايه بوت 😒🔪","انت البوت 😒💔"} 
...
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'فايروس')
local DevProxTEAM = {'😸♥️ هلا قلبي وياك '..NameBot..' تفضل','ترةه مصختهاا قول عايز ايه 😕😒💔','اطلقق واحدد يقول '..NameBot..' 😻♥️','خبصتت امنةة شتريدد عااد 🤧😒💔'} 
Dev_Abs(msg.chat_id_, msg.id_, 1, DevProxTEAM[math.random(#DevProxTEAM)] , 1, 'html') 
return false 
end
...
local DevProxTEAM = "ياليل" 
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md') 
local DevProxTEAM = { "اخرس @"..username.." احترم اسيادك ولا تعصبهم،💩🖐🏿","هششش روح العب بعيد @"..username.." انت حيوان كلب، 😖👌🏿","حبيبي @"..username.." راح احاول احترمك المره دي، 🤔🔪","انت @"..username.." ما في احترام صديق 😏🖕🏿","يابو راس مربع @"..username.." شفيك معصب الاستاذ يلا انجلع اعتذر😒🔪",}
...
local DevProxTEAM = "ياليل" 
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md') 
local DevProxTEAM = {"اخرس احترم اسيادك ولا تعصبهم،💩🖐🏿","هشش فاشل انت حيوان كلب، 😖👌🏿","انت ما في احترام صديق 😏🖕🏿","يابو راس مربع شفيك معصب الاستاذ يلا انجلع اعتذر😒🔪","حبيبي راح احاول احترمك المره دي، 🤔🔪"} 
...
if text == "راسلني" then
DevProxTEAM = {"ها هلاو","انطق","قول حبي","تفضل"};
...
--     Source Virus     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع حيوان$") and not DevAbs:get(DevProx..'Abs:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source Virus     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل حيوان$") and not DevAbs:get(DevProx..'Abs:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
...
sudobot = '\n⌁︙عدد القروبات ↫ '..(DevAbs:get(DevProx..'Abs:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n⌁︙عدد القروبات ↫ '..(DevAbs:get(DevProx..'Abs:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n⌁︙عدد القروبات ↫ '..(DevAbs:get(DevProx..'Abs:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌁︙عدد القروبات الان ↫ { '..#group..' }'..DevProxgp1..DevProxgp2..'\n⌁︙العدد الحقيقي الان  ↫ ( '..DevProxgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
{{text = '⌁ VIRUS TeAM .',url="t.me/CODEARAB"}},
}
...
if text == "الهاشتاج" then if DevAbs:get(DevProx..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local DevProxTEAM = "\n" .."⌁︙الهاشتاج ↫ "..lock_htag.."\n"Dev_Abs(msg.chat_id_, msg.id_, 1, DevProxTEAM, 1, 'md') end
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/CODEARAB' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "CODEARAB")..")"
else 
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './DevProx.lua', '⌁︙نسخة ملف سورس فايروس',dl_cb, nil)
end end
--     Source Virus     --
...
os.execute('wget https://raw.githubusercontent.com/cqxee/Virus/master/DevProx.lua') 
dofile('DevProx.lua') 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ [@CODEARAB]', 1, 'md')    
end 
--     Source Virus     --
